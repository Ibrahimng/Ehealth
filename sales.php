...
<html xmlns="http://www.w3.org/1999/xhtml" class="ihome">
    ...
    <body>
		...
		<center>
		<table border="5px"><form action=payment.php MEthod=post>
		<tr>
		<th style="padding:10px;">
		<center>
		<img src="ads/1.jpg" height="250px" width="200px"/><br><hr>
		<button class="btn btn-primary" name="buy" type="submit" value="2000">Rs. 2000/-</button><br></center>
		</th>
		<th style="padding:10px;"><center>
		<img src="ads/2.jpg" height="250px" width="200px"/><br><hr>
		<button class="btn btn-primary" name="buy" type="submit" value="3000">Rs. 3000/-</button><br></center>
		</th>
		<th style="padding:10px;"><center>
		<img src="ads/3.jpg" height="250px" width="200px"/><br><hr>
		<button class="btn btn-primary" name="buy" type="submit" value="1900">Rs. 1900/-</button><br></center>
		</th>
		<th style="padding:10px;"><center>
		<img src="ads/6.jpg" height="250px" width="200px"/><br><hr>
		<button class="btn btn-primary" name="buy" type="submit" value="2100">Rs. 2100/-</button><br></center>
		</th>
...
<br><br>
    ...
    <script type="text/javascr  .ipt" src="js/jquery.scrollUp.min.js"></script>
