                    ...
                    <div class=" top-bar container">
                    	<div class="row">
                          ...
                          <a href="index.html"><div class=""><img src="images/logo.png"/></div></a>
                            ...
                            <li class="active"><a href="profile.php"><i class="icon-home"></i>Profile</a></li>
...
<?php
echo "<img src='$img' width=140px height=140px/><br>";
...
?>
	 ...
	 <?php
	   echo '<tr>
	   <th style="padding:10px;">Name:</th><td style="padding:10px;">'.$_SESSION["name"].'</td>';
	   echo'</tr> <tr>';
	   echo '<th style="padding:10px;">Email</th><td style="padding:10px;">'.$_SESSION["email"]."</td></tr>";
		

echo '<tr><th style="padding:10px;">Date of Birth:</th><td style="padding:10px;">'.$_SESSION["dob"].'</td></tr>';

echo '<tr><th style="padding:10px;">Address:</th><td style="padding:10px;">'.$_SESSION["address"].'</td></tr>';
echo '<tr><th style="padding:10px;">Address:</th><td style="padding:10px;">'.$_SESSION["history"].'</td></tr>';

?>
	   </table>
	   <br>
<a href="appointment.php"><button class="btn btn-lg btn-primary btn-success" onclick="appointment.php" /><h3 style="color:white;">Take An Appointment</h3></a>
	  </center>
<br><br>
			</center>
			</div>
