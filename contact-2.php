    ...
    <div class="container">
            ...
            <div class="topbar-info no-pad">                    
                        <div class="container">                     
                            ...
                            <div class="top-info-contact pull-right col-md-6">Call Us Today! +123 455 755  |    contact@fortis.com  <div id="search" class="fa fa-search search-head"></div>
                            </div>                      
                        </div>
                      ...
                      <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                          ...
                          <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown active"><a href="contact-2.php" class="dropdown-toggle"><i class="icon-envelope"></i>Contact Us<b class="icon-angle-down"></b></a>
                        ...
                        <div class="hide-mid collapse navbar-collapse option-drop" id="bs-example-navbar-collapse-2">
                          ...
                          <ul class="nav navbar-nav navbar-right other-op">
                            ...
                            <li><i class="icon-mail"></i><a href="#" class="mail-menu">fortis@companyname.com</a></li>
                ...
                <div class="row">
                    ...
                    <div class="contact-widgets">
                        ...
                        <div class="contact-widget-box col-md-3 col-lg-3 col-sm-6 col-xs-12 wow bounceIn" data-wow-delay="0.5s" data-wow-offset="150">
                            ...
                            <p>Fortis Health Care Centre, Mulund, Mumbai, India.</p>
                        </div>
                        ...
                        <div class="contact-widget-box col-md-3 col-lg-3 col-sm-6 col-xs-12 wow bounceIn" data-wow-delay="1.1s" data-wow-offset="150">
                            ...
                            <p><a href="mailto:contact@imedica.com">contact@fortis.com</a></p>
                        </div>
