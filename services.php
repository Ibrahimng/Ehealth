...
<body>
                      ...
                      <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                          ...
                          <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown active"><a href="services.php" class="dropdown-toggle" ><i class="icon-cog"></i>Services<b class="icon-angle-down"></b></a>
							...
							<li><a href="faq.php"><i class="icon-home"></i>FAQs</a></li>
                        ...
                        <div class="hide-mid collapse navbar-collapse option-drop" id="bs-example-navbar-collapse-2">
                          ...
                          <ul class="nav navbar-nav navbar-right other-op">
                            ...
                            <li class="dropdown active"><a href="fbox.html" class="dropdown-toggle" ><i class="icon-cog"></i>Services<b class="icon-angle-down"></b></a>
                               
                            </li>
                            
                            <li class="dropdown"><a href="services.html" class="dropdown-toggle"><i class="icon-file"></i>About US<b class="icon-angle-down"></b></a>
                               </li>
    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Facilities</h1></div>
            	...
            	<div class="flip-box auto horizontal_flip_left" data-animation="" data-animation-delay="03" >
                	<div class="ifb-flip-box">
                    	...
                    	<div class="ifb-face ifb-front">
                            ...
                            <p>Find out the Cardiac problems and give the suitable treatment !</p>
                        </div><!-- END .front -->
            	...
            	<div class="flip-box auto horizontal_flip_left" data-animation="" data-animation-delay="03" >
                	<div class="ifb-flip-box">
                    	...
                    	<div class="ifb-face ifb-front">
                            ...
                            <h3 class="flip-box-head-txt">Cancer Detection</h3>
                            <p>Various tests to detect the cancer at early stages.</p>
                        </div><!-- END .front -->
            	...
            	<div class="flip-box auto horizontal_flip_left" data-animation="" data-animation-delay="03" >
                	<div class="ifb-flip-box">
                    	...
                    	<div class="ifb-face ifb-front">
                            ...
                            <p>Highly effective treatments for both the problems !</p>
                        </div><!-- END .front -->
            	...
            	<div class="flip-box auto horizontal_flip_left" data-animation="" data-animation-delay="03" >
                	<div class="ifb-flip-box">
                    	...
                    	<div class="ifb-face ifb-front">
                            ...
                            <p>With full time staff to look after the patient !</p>
                        </div><!-- END .front -->
                        
							<div class="ifb-face ifb-back flip-backface">
                                <h3>Caring Staff</h3>
                                <p>With full time stff to look after the patient !</p>
                                <div class="flip_link"><a href="" class="flip-read-more">Read More!</a></div>
                            </div><!-- END .back -->
