...
<html xmlns="http://www.w3.org/1999/xhtml" class="ihome">
    ...
    <body>
                    ...
                    <div class=" top-bar container">
                    	<div class="row">
                          ...
                          <a href="index.html"><div class=""><img src="images/logo.png"/></div></a>
                            ...
                            <li class="dropdown"><a href="about-us.html" class="dropdown-toggle" ><i class="icon-file"></i>About Us<b class="icon-angle-down"></b></a>
							...
							<li class="active"><a href="login.php"><i class="icon-home"></i>Login</a></li>
		...
		<th style="padding:20px;background-color:#ffffff;">
		 <form class="form-signin" method="post" action="verify_login.php"  name="feedback" enctype="multipart/form-data">
		
        <center><h2 class="form-signin-heading"  >Login</h2></center><hr style="border: 1px solid black">
		...
		Password:
        <input type="password" name="pass" id="pass" class="form-control" placeholder="Password" autofocus>
		<br>
		
		<center>
        <button class="btn btn-lg btn-primary btn-success" type="submit" value="submit" name="submit" >Log in</button>
		
		<button class="btn btn-lg btn-primary " type="reset"  value="reset">Clear</button>
		</center>	
     <br><br>
		Not a member yet?<a href="register.html"> <u>Register/Signup</u></a>
	  </form>
	  </th></tr>
	  </table>
