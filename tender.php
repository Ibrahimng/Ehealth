...
$comment=$_POST['comment'];			
			mysql_query("INSERT INTO tender(name,email,rating,text) VALUES('$name','$email','$rating','$comment')");
	}		
			?>
<!DOCTYPE HTML>
...
<html xmlns="http://www.w3.org/1999/xhtml" class="ihome">
    ...
    <body>
		...
		<th style="padding:20px;background-color:#ffffff;">
		 <form class="form-signin" method="post" action="tender.php"  name="feedback" enctype="multipart/form-data">
		
        <center><h2 class="form-signin-heading"  >Tender</h2></center><hr style="border: 1px solid black">
		...
		<br>
		Years Active:
        <input type="text" name="year" id="year" class="form-control" placeholder="Email@address" autofocus>
		<br>
		Registration Number:
        <input type="text" name="reg" id="reg" class="form-control" placeholder="Email@address" autofocus>
		<br>
		Tender for:
        <input type="text" name="tf" id="tf" class="form-control" placeholder="Email@address" autofocus>
		<br>
		Tender value:
        <input type="text" name="tv" id="tv" class="form-control" placeholder="Email@address" autofocus>
		<br>
		Contract Duration:
        <input type="text" name="cd" id="cd" class="form-control" placeholder="Email@address" autofocus>
		<br>
		
		<br>
		Awards Received:
        <textarea rows="5" name="award" id="award" cols="60" class="form-control" placeholder="Enter your comments here" autofocus>
		</textarea> 
		<br>
		<center>
        <button class="btn btn-lg btn-primary btn-success" type="submit" value="submit" name="submit" >-- Submit --</button>
		
		<button class="btn btn-lg btn-primary " type="reset"  value="reset">-- Clear --</button>
		</center>	
