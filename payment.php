...
$amount=$_POST['amount'];
			...
			mysql_query("INSERT INTO sales(name,pay,amount) VALUES('$name','$pay','$amount')");
	}		
			?>
<!DOCTYPE HTML>
...
<html xmlns="http://www.w3.org/1999/xhtml" class="ihome">
    ...
    <body>
		...
		<th style="padding:20px;background-color:#ffffff;">
		 <form class="form-signin" method="post" action="payment.php"  name="payment" enctype="multipart/form-data">
		
        <center><h2 class="form-signin-heading"  >Payment Form</h2></center><hr style="border: 1px solid black">
		...
		Payemnt Type:
		<select type="dropdown" name="pay" id="rating" class="form-control" placeholder="select rating 1-5" autofocus>
  ...
  <option value="cash">Cash on Delivery</option>
		...
		<br>
		Amoun
        <input type="text" name="amount" id="amount" class="form-control" placeholder="Name" autofocus   value="2000"/>
		<br>
		<br>
		<center>
