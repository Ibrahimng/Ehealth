...
$comment=$_POST['comment'];			
			mysql_query("INSERT INTO feedback(name,email,rating,text) VALUES('$name','$email','$rating','$comment')");
	}		
			?>
<!DOCTYPE HTML>
...
<html xmlns="http://www.w3.org/1999/xhtml" class="ihome">
    ...
    <body>
		...
		<th style="padding:20px;background-color:#ffffff;">
		 <form class="form-signin" method="post" action="feedback.php"  name="feedback" enctype="multipart/form-data">
		
        <center><h2 class="form-signin-heading"  >FeedBack Form</h2></center><hr style="border: 1px solid black">
		...
		<br>
		Rating:
		<select type="dropdown" name="rating" id="rating" class="form-control" placeholder="select rating 1-5" autofocus>
  ...
  <option value="1">1</option>
		...
		<br>
		Comments:
        <textarea rows="5" name="comment" id="comment" cols="60" class="form-control" placeholder="Enter your comments here" autofocus>
		</textarea> 
		<br>
		<center>
