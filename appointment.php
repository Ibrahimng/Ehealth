<?php
	session_start();		$mysql_hostname = "localhost";
$mysql_user = "root";
$mysql_password = "";
...
$doc=$_POST['doc'];echo"submitted";
			
			mysql_query("INSERT INTO appointment(name,email,doc_name,date,time) VALUES('$name','$email','$doc','$date','$time')");
	}		
			?>	
<!DOCTYPE HTML>
...
<html xmlns="http://www.w3.org/1999/xhtml" class="ihome">
    ...
    <body>
            ...
            <div class="container">
                    ...
                    <div class=" top-bar container">
                       ...
                       <li><a href="profile.php"><i class="icon-home"></i>Profile</a></li>
							<li class="active"><a href="appointment.php"><i class="icon-home"></i>Appointment</a></li>
		...
		<th style="padding:20px;background-color:#ffffff;">
		 
		
        <center><h2 class="form-signin-heading"  >Appointment Form</h2></center><hr style="border: 1px solid black">
		<form name=appt id=appt action="appointment.php" method=POST>
<table border=2>
<tr>
<td style="padding:10px;"><select type="dropdown" name="doc" id="doc" class="form-control" placeholder="select doctor" autofocus>
		
  <option value="Dr. Arjun Bhadra">Dr. Arjun Bhadra</option>
  <option value="Dr. Annvay Agte">Dr. Annvay Agte</option>
  <option value="Dr. Aishwarya parmeshwaran">Dr. Aishwarya parmeshwaran</option>
  <option value="Dr. Nishant Singhal">Dr. Nishant Singhal</option>
  
  
</select></td>
<td style="padding:10px;"><input type=date name=date type=date/></td> 
<td style="padding:10px;"><select type="dropdown" name="time" id="time" class="form-control" placeholder="select time slot" autofocus>
		
  <option value="10">10am-12am</option>
  <option value="14">2pm-5pm</option>
  <option value="19">7pm-10pm</option>
  
  
</select></td>
<td style="padding:10px;">
<button class="btn btn-lg btn-primary btn-success" type="submit" value="submit" name="submit" >Take appintment</button></td>
</tr>
</table>
</form>
